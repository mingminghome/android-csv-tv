...
- **Advanced Headless Extraction**:
  ...
  - **Dynamic Injector Support**: Specifically optimized to resolve streams from dynamic scripts and IPTV injectors.
- **Next-Gen Playback**:
...
- **`SetupActivity.kt`**: Configuration and source settings.
